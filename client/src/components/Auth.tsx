...
export default function Auth({ onAuthSuccess }: { onAuthSuccess: (data: AuthResponse) => void }) {
  ...
  return (
    /* A mágica acontece aqui: min-h-screen garante a altura toda da tela, e flex com items-center e justify-center centraliza tudo no meio */
    <div className="w-full min-h-screen bg-zinc-950 flex flex-col justify-center items-center p-4">
      <div className="w-full max-w-md bg-zinc-800 rounded-lg shadow-md p-8">
        ...
        <div className="flex gap-2 mb-6">
          <button
            ...
            className={`flex-1 py-2 px-4 rounded-md transition-colors ${!isSignUp
